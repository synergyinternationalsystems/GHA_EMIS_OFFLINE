...
<Project DefaultTargets="Build" ToolsVersion="14.0" xmlns="http://schemas.microsoft.com/developer/msbuild/2003">
  ...
  <PropertyGroup Label="Globals">
    <ProjectGuid>{A2686132-2BE4-06B1-1956-2AF40F9838BA}</ProjectGuid>
  ...
  <ItemGroup>
    <CustomBuild Include="$(OutDir)\node_sqlite3.node">
      ...
      <Command>call mkdir &quot;D:\Workspace_Apollo\Ghana_EMIS\gha-emis-offline-production\node_modules\sqlite3\lib\binding\electron-v1.4-win32-ia32&quot; 2&gt;nul &amp; set ERRORLEVEL=0 &amp; copy /Y &quot;$(OutDir)node_sqlite3.node&quot; &quot;D:\Workspace_Apollo\Ghana_EMIS\gha-emis-offline-production\node_modules\sqlite3\lib\binding\electron-v1.4-win32-ia32\node_sqlite3.node&quot;&#xD;&#xA;if %errorlevel% neq 0 exit /b %errorlevel%</Command>
      <Message>Copying $(OutDir)/node_sqlite3.node to D:/Workspace_Apollo/Ghana_EMIS/gha-emis-offline-production/node_modules/sqlite3/lib/binding/electron-v1.4-win32-ia32\node_sqlite3.node</Message>
      <Outputs>D:\Workspace_Apollo\Ghana_EMIS\gha-emis-offline-production\node_modules\sqlite3\lib\binding\electron-v1.4-win32-ia32\node_sqlite3.node</Outputs>
    </CustomBuild>
  </ItemGroup>
  <ItemGroup>
    <ProjectReference Include="node_sqlite3.vcxproj">
      <Project>{8D1616D9-D8BD-2AD0-8EEE-77D776517AD1}</Project>
